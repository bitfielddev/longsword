...
function SWEP:InsertShell()
	...
	self:PlayAnim( (self.DoEmptyReloadAnim and self:Clip1() <= 0) and ACT_VM_RELOAD_EMPTY or ACT_VM_RELOAD )
	self:QueueIdle()
...
function SWEP:ReloadThink()
	...
	if self:Clip1() < (self.Primary.ClipSize + (self.DoEmptyReloadAnim and 1 or 0)) and self.Owner:GetAmmoCount( self:GetPrimaryAmmoType() ) > 0
